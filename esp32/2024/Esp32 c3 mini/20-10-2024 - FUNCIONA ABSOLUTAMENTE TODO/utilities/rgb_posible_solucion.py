...
# from modules.touch_sensor import test_mqtt
...
#                 (wlan_sta, is_wifi_connected, handle_wifi_connection, is_wifi_network_connected) = get_wifi()
        ...
        if wifi.is_connected and mqtt and "update_device" in mqtt:
            mqtt["update_device"](led_name, "asd")
...
#         print("Antes del publish - client",  client)
#             
#         if wifi.is_connected and client:
#             print("Entra y hace push")
#             client.publish("asd", "asd")

                
#         time.sleep(2)
#         callback_update_server()

#         dimmer_touch_pin.test(update_device)
        touch_response = dimmer_touch_pin.is_touching((callback_pulse, callback_two_touching, callback_three_touching),
            callback_update_server, callback_dimmer)
        
#         value = touch_response["value"]
#         touch_count = touch_response["touch_count"]
#         
#         if value == False and touch_count > 0:
...
#         test_mqtt(callback_update_server)

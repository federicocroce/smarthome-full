...
try:
    import umqtt.robust
    print(getattr(umqtt.robust, '__version__', 'Versión desconocida'))
except ImportError:
    print("umqtt.robust2 no está instalado")
...
def main():
    ...
    def keep_mqtt_connection_cbk():
        ...
        mqtt.client.publish('reconnect', "Wifi y MQTT reconectado")

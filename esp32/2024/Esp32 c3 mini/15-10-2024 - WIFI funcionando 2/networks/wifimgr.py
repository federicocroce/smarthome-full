...
#         return wlan_sta
#     print("ENTRAAA 1")
# #     connected = do_connect("WiFi-Arnet-knt5_2,4_EXT","cmq3ntce", blinking_led, set_leds_on_wifi_connected)
#     connected = False
#     try:
#         print("ENTRAAA 2")
...
#         
#         
#         print("is active", wlan_sta.active())
#         
#         networks = None
#         
# #         print("wlan_sta.scan()", wlan_sta.scan())
...
# 
# #     if connected:
#     wifi = (wlan_sta, is_wifi_connected, handle_wifi_connection, is_wifi_network_connected)
# 
#     return wifi
# 
# 

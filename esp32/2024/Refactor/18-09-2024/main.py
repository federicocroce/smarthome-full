...
# def dimmer_led(led_name, touch_dimmer_sensor, dimmer_speed= 20):
#     print("Setea el brillo")
#     while True:
#         try:
#             device_config[led_name]['device']['dimmer_touch'](
#                 touch_dimmer_sensor)
...
# 
# 
# led_thread = _thread.start_new_thread(dimmer_led, ('led1', touch_dimmer_sensor))

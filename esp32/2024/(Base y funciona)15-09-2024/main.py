...
from DeviceConfig import set_device, init_device, device_config, get_device, get_devices_status, update_devices_status
from TouchSensor import Touch as TouchSensor
from Touch import Touch
import wifimgr
import utime
from Sensor import sensor_init
...
(wlan_sta, is_wifi_connected, handle_wifi_connection, is_wifi_network_connected) = wifi_manager
...
def dimmer_led():
    ...
    while True:
        try:
            device_config['led1']['device']['dimmer_touch'](touch_dimmer_sensor)
            time.sleep_ms(20)

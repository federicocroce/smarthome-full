...
def format_led_rgb(pin_red, pin_green, pin_blue, led_name):
    ...
    def update_device():
        ...
        (wlan_sta, is_wifi_connected, handle_wifi_connection) = get_wifi()
        mqtt = get_mqtt()
...
#             set_led_values(spectrumrgb, duty, is_on, temperature, new_is_growing)
        ...
        dimmer_touch_pin.is_touching(callback_update_server, callback_pulse, callback_dimmer)

...
// const actions_topics = {
//   [mqttTopics.mi_topic]: (message) => {
//     clientMqtt.publish(
//       mqttTopics.mi_topic_response,
//       `${topic} desde actions_topics : ${message.toString()}`
//     );
//   },
// };
...
//   const action = actions_topics[topic];
...
//   clientMqtt.publish("mi_topic", `Hola desde el server ${text}`);
